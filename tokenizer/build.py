# python build stubs for package tokenizer
...
mod = Module('_tokenizer')
mod.add_include('"tokenizer_go.h"')
...
mod.add_function('Array_2_string_CTor', retval('int64_t'), [])
mod.add_function('Array_2_string_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Array_2_string_elem', retval('char*'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Array_2_string_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('char*', 'value')])
mod.add_function('Slice__2_string_CTor', retval('int64_t'), [])
mod.add_function('Slice__2_string_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Slice__2_string_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'idx')])
mod.add_function('Slice__2_string_subslice', retval('int64_t'), [param('int64_t', 'handle'), param('int', 'st'), param('int', 'ed')])
mod.add_function('Slice__2_string_set', None, [param('int64_t', 'handle'), param('int', 'idx'), param('int64_t', 'value')])
mod.add_function('Slice__2_string_append', None, [param('int64_t', 'handle'), param('int64_t', 'value')])
mod.add_function('Map__2_string_int64_CTor', retval('int64_t'), [])
mod.add_function('Map__2_string_int64_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Map__2_string_int64_elem', retval('int64_t'), [param('int64_t', 'handle'), param('int64_t', '_ky')])
mod.add_function('Map__2_string_int64_contains', retval('bool'), [param('int64_t', 'handle'), param('int64_t', '_ky')])
mod.add_function('Map__2_string_int64_set', None, [param('int64_t', 'handle'), param('int64_t', 'key'), param('int64_t', 'value')])
mod.add_function('Map__2_string_int64_delete', None, [param('int64_t', 'handle'), param('int64_t', '_ky')])
mod.add_function('Map__2_string_int64_keys', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('Map_int64_string_CTor', retval('int64_t'), [])
mod.add_function('Map_int64_string_len', retval('int'), [param('int64_t', 'handle')])
mod.add_function('Map_int64_string_elem', retval('char*'), [param('int64_t', 'handle'), param('int64_t', '_ky')])
mod.add_function('Map_int64_string_contains', retval('bool'), [param('int64_t', 'handle'), param('int64_t', '_ky')])
mod.add_function('Map_int64_string_set', None, [param('int64_t', 'handle'), param('int64_t', 'key'), param('char*', 'value')])
mod.add_function('Map_int64_string_delete', None, [param('int64_t', 'handle'), param('int64_t', '_ky')])
mod.add_function('Map_int64_string_keys', retval('int64_t'), [param('int64_t', 'handle')])
...
mod.add_function('tokenizer_Encoder_CTor', retval('int64_t'), [])
mod.add_function('tokenizer_Encoder_Encoder_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('tokenizer_Encoder_Encoder_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('tokenizer_Encoder_Decoder_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('tokenizer_Encoder_Decoder_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('tokenizer_Encoder_BPERanks_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('tokenizer_Encoder_BPERanks_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('tokenizer_Encoder_Cache_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('tokenizer_Encoder_Cache_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
mod.add_function('tokenizer_Encoder_VocabSize_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('tokenizer_Encoder_VocabSize_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
add_checked_function(mod, 'tokenizer_Encoder_BPE', retval('int64_t'), [param('int64_t', '_handle'), param('char*', 'token')])
add_checked_function(mod, 'tokenizer_Encoder_EncodeWords', retval('int64_t'), [param('int64_t', '_handle'), param('int64_t', 'words')])
add_checked_function(mod, 'tokenizer_Encoder_Encode', retval('int64_t'), [param('int64_t', '_handle'), param('char*', 'text')])
add_checked_string_function(mod, 'tokenizer_Encoder_Decode', retval('char*'), [param('int64_t', '_handle'), param('int64_t', 'tokens')])
add_checked_function(mod, 'tokenizer_New', retval('int64_t'), [param('int64_t', 'encoder'), param('int64_t', 'bpeMerges')])
add_checked_function(mod, 'tokenizer_NewFromPrebuilt', retval('int64_t'), [param('char*', 'name')])
add_checked_function(mod, 'tokenizer_NewFromReaders', retval('int64_t'), [param('int64_t', 'encoderReader'), param('int64_t', 'vocabReader')])
add_checked_function(mod, 'tokenizer_WordSplit', retval('int64_t'), [param('char*', 's')])

mod.generate(open('tokenizer.c', 'w'))
